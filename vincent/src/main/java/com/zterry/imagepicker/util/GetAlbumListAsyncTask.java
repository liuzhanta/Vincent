 ...
 * Date:2016-02-18
 */
public class GetAlbumListAsyncTask extends AsyncTask<Void, Void, List<PhotoAlbum>> {

    public static final String TAG = "GetAlbumListAsyncTask";

    private Context context;
    private List<PhotoAlbum> mPhotoAlbums = new ArrayList<>();

    public GetAlbumListAsyncTask(Context context) {
        this.context = context;
    }

    public GetAlbumListAsyncTask() {

    }

    @Override
    protected List<PhotoAlbum> doInBackground(Void... params) {
        return doGetAlbumList();
    }
     ...
     */
    private List<PhotoAlbum> doGetAlbumList() {
        //1.-----------------------> 查询缩略图 <-----------------------
